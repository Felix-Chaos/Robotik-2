...
figure('Name', 'IMU 3-Axis Movement Analysis', 'NumberTitle', 'off', 'Position', [100, 100, 1400, 800]); % Made wider for more plots
t = tiledlayout(3, 4, 'TileSpacing', 'Compact', 'Padding', 'Compact'); % Changed to 4 columns
...
for i = 1:3
    ...
    calc_rotation_accel = calc_rotation_accel - calc_rotation_accel(1, :);
    ...
    all_axes = [all_axes, ax1, ax2, ax3, ax4]; %#ok<AGROW>
end
